...
verified commit straight to the ONE feature branch they authorized. ARCC guidance
(software-supply-chain-security-standards) is explicit that the CR / branch-protection
review is the mandated trust gate; relaxing it is only safe when (a) the human explicitly
...
# of the CR review gate (ARCC: "code review process enforced through branch protection
# rules"). Direct-commit is for your OWN feature branch; a shared branch always falls
